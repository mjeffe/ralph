...
5. **Create AGENTS.md template**
   ...
   - Include Ralph requirements section (## Specifications)
   - Include example project guidelines sections
   - Add clear comments distinguishing required vs customizable sections
   - Dependencies: Task 2 (file reorganization)
...
9. **Implement ralph init command**
   ...
   - Handle AGENTS.md intelligently (create from template if missing, warn if exists)
   - Output instructions and next steps
   - Dependencies: Task 3 (path updates), Task 5 (AGENTS.md template)
...
10. **Final testing and validation**
    ...
    - Test AGENTS.md creation and warning scenarios
...
### Spec Status
- test-simple-calculator.md: ✅ Implemented (calculator module complete, all 18 tests passing)
...
- After Task 3: Run .ralph/ralph --help to verify paths work
- After Task 9: Test ralph init with and without existing AGENTS.md
