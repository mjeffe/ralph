...
7. Move documentation to .ralph/docs/
...
9. Update .ralph/loop.sh path references
...
10. Update .ralph/prompts/PROMPT_build.md
...
12. Implement 'ralph init' command
...
13. Update specs/ralph-overview.md
...
14. Create .ralph/docs/installation.md
...
17. Test installation in fresh project
    - Create test project
    - Run install.sh
    - Run ralph init
    - Verify structure and functionality

18. Update specs/README.md
